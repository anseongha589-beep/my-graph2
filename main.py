...
# ==================================================
st.markdown("---")
st.header("8️⃣ 가장 인기가 많은 영화는 무엇인가")


st.markdown(
    """
    **총 관객수(total_audi)**가 많은 영화를 비교해
    가장 많은 관객을 모은 영화 TOP 10을 확인합니다.

    막대가 길수록 총 관객수가 많은 영화입니다.
    영화에 마우스를 올리면 영화명과 총 관객수를 확인할 수 있습니다.
    """
)
